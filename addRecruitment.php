<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST")
    {
       ...
       $isreappointed = 0;
		...
		//echo $currentTution;
		if($projid == ""){
       		$Query2 ="INSERT INTO Recruitments(student_id, faculty_id, semester, currentpost,year,tutionwaive,credithours,currenttution,salarypaid,hours,isreappointed,offerstatus,startdate,enddate,fundingtype) VALUES ('$studentid','$facultyid','$semester','$currentpost','$year',$tution,$noofcredits,$currentTution,$salarypaid,$hoursip,$isreappointed,'0','$startdate' ,'$enddate',$fundingip )"; //SQL query
		}else{
